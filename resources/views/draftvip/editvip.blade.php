...
<head>
    <title>Edit Kepala Divisi</title>
    @include('layout.head')
</head>
        ...
        <div class="p-6 mx-auto w-full">
            <div class="border-black/12.5 shadow-soft-xl z-20 grid grid-cols-1 break-words border-solid bg-white bg-clip-border rounded-3xl">
                <div class="border-black/12.5 border-solid bg-white p-6 rounded-3xl space-y-16">
                    <div>
                    <h1 class="text-2xl font-bold text-center">Edit Kepala Divisi</h1>
                    </div>
                    <form method="post" action="{{ route('Updatevip', ['edits' => $edits]) }}">
                        @csrf
                        @method('put')
                        <div class="grid gap-6 grid-cols-1 md:grid-cols-2 xl:grid-cols-2 max-w-3xl mx-auto">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text"
                                    class="bg-gray-50 border border-gray-300 text-gray-900  rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                    id="nip" name="nip" placeholder="nip" value="{{ $edits->nip }}">
                            </div>
                            <div class="space-y-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text"
                                    class="bg-gray-50 border border-gray-300 text-gray-900  rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                    id="npwp" name="npwp" placeholder="NPWP" value="{{ $edits->npwp }}">
                            </div>
                            <div class="space-y-2">
                                <label for="exampleFormControlInput1" class="block  font-semibold text-black">Nama
                                    Bank :</label>
