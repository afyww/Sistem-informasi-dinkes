                                ...
                                @foreach ($daftar as $item)
                                    <tr class="bg-white border-b">
                                        ...
                                        <td class="inline-block px-6 py-4">
                                            <form method="post">
                                                <a href="{{ route('draft.edit', ['edits' => $item]) }}"
                                                    class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br rounded-3xl text-sm px-5 py-2 text-center">Edit</a>
                                                @csrf
                                                @method('delete')
                                                <a href="{{ route('Destroy', ['edits' => $item]) }}"
